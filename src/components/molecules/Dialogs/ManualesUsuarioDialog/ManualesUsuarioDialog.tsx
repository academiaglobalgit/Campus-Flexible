...
export const ManualesUsuarioDialog: React.FC<GlosarioDialogProps> = ({ isOpen, close, menutype }) => {
    ...
    const manuales: MenuItemManual[] = [
        ...
        { id: 'lineamiento-normas', icon: ManualInduccion, label: 'Lineamientos y Normas de Control Escolar', action: () => abrirManualPorId(0), type: 'lineamientos', url: obtenerUrlPorIdManual(0) },

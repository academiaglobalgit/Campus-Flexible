...
import { Box, CircularProgress, Divider, Tab, Tabs, useMediaQuery } from "@mui/material";
...
const Logros: React.FC = () => {
    ...
    const Insignia = (racha: string, fecha: string) => {
        return (
            <Box sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', gap: '10px', width: '277px' }}>
                <Box
                    component="img"
                    src={medalla}
                    alt="medalla"
    ...
    const Certificaciones = (cv: string, download: string) => (
        <>
            <Box sx={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between', mt: 1, gap: 2 }}>
                ...
                <Box sx={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-around', width: '350px' }}>
        ...
        isMobile
            ...
            <>
                <Box sx={{ display: 'flex', flexDirection: 'column', height: 'auto' }}>
                    <Box sx={{ display: 'flex' }}>
                        <Box>
                            ...
                            <Box sx={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
                                <Box sx={{ display: 'flex', flexDirection: isMobile ? 'column' : 'row', justifyContent: 'space-between', alignItems: 'center', gap: '30px' }}>
                    ...
                    <Box sx={{ maxWidth: { xs: 600, sm: 600 }, bgcolor: 'background.paper' }}>
                        <Tabs
                            value={value}
                    ...
                    <TabPanel value={value} index={0} dir={theme.direction}>
                        <Box sx={{ display: 'flex', flexDirection: 'column', width: '100%', backgroundColor: '#F1F4F6', height: '350px', borderRadius: '20px' }}>
                            ...
                            <Box sx={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', width: '100%', backgroundColor: '#F1F4F6', height: '50%' }}>
